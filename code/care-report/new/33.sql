...
FROM (SELECT DISTINCT deta.POLICY_NO,
      ...
      FROM `LP_FBDB/FCLDETA0` AS deta
           ...
           (SELECT ddtm.ITEM,
            ...
            GROUP BY ddtm.ITEM, ddtm.DECL_YN) AS ddtm1
         ...
         INNER JOIN `LP_FBDB/FCLDETA0` AS deta2
                    ON
                        (
                                ...
                                AND deta2.CLAIM_ITEM IN
                                    ('A11E', 'A172', 'H116', 'A102', 'G105', 'A11P', 'A113', 'A11H', 'A11I', 'H117',
                                     'G101', 'A171', 'A112', 'A11O', 'A11F', 'A604', 'A603', 'A601', 'A11D',
                                     'A11Q', 'A12B', 'A12D', 'A12E', 'A12F', 'A18B', 'A181', 'A812', 'A814', 'G10A',
                                     'G118', 'G604', 'G806', 'H115')
                            )
         ...
         LEFT JOIN `LP_FBDB/FPMRIDE0` AS ride
                   ON
                       (
                               ...
                               AND ride.CNCT_STAT IN
                                   ('01', '02', '03', '04', '05', '06', '07', '16', '20', '25', '27', 'WP')
                           )
     ...
     (SELECT deta3.POLICY_NO,
      ...
      WHERE deta3.ITEM IN
            ('CLJ', 'CLL', 'EDUC', 'XLJ', 'XCR', 'XWU', 'XLT', 'XDA', 'XDB', 'XDC', 'XTF', 'XDH', 'XAR', 'XAR1', 'XDK',
             'XDN', 'XIR', 'XOR', 'XTG', 'XTR', 'XWO', 'SWC', 'EDUB', 'AIH', 'AIO', 'AHY', 'IPAC', 'FIB1', 'F1B2',
             'FIB3', 'FIB4', 'FIB5', 'FIC1', 'FIC2', 'FIC3', 'FIC4', 'FIC5', 'XDN1', 'XDR', 'XDR1', 'XLZ', 'XNR', 'XTO',
             'XDS', 'XQR', 'PCC2', 'XNR', 'IXB', 'SWC', 'AI55', 'AI60', 'AI65')
        AND deta3.CLAIM_STS LIKE 'P%'
        AND deta3.CLAIM_ITEM IN
            ('A11E', 'A172', 'H116', 'A102', 'G105', 'A11P', 'A113', 'A11H', 'A11I', 'H117', 'G101', 'A171', 'A112',
             'A11O', 'A11F', 'A604', 'A603', 'A601', 'A11D', 'A11Q', 'A12B', 'A12D', 'A12E', 'A12F', 'A18B', 'A181',
             'A812', 'A814', 'G10A', 'G118', 'G604', 'G806', 'H115')
      GROUP BY deta3.POLICY_NO, ID_DUP, POLICY_SEQ, ITEM
      ORDER BY deta3.POLICY_NO, ID_DUP, POLICY_SEQ, ITEM) AS accd
     ON
         (

...
SELECT DISTINCT prim.RGST_NO,
                ...
                CASE
                    ...
                    ELSE ride.CNCT_STAT
                    END AS cnst,
                deta2.CLAIM_ITEM,item.CLAIM_NAME,
                deta2.CLAIM_AMT,deta2.CLAIM_STS,
                (prim.BIRTH_YY*10000+prim.BIRTH_mm*100+prim.BIRTH_dd) AS BRITHDAY,
                prim.APPLY_ID,prim.APPLY_UNIT,
                prrs.ACDN_NAME,note.CL_TEXT,
                pynf.TEL_NO,
                prim.APPLY_UNIT,
                prim.APPLY_ID,
                CASE
                ...
                CASE
                    WHEN ride.CNCT_STAT IS NULL THEN fhsf.CNCT_STAT
                    ELSE ride.CNCT_STAT
                    END ||lastday.DECL_YN AS checkcode -- 註解: CONCAT
FROM
    (
        SELECT DISTINCT deta.POLICY_NO,
                        deta.ID_DUP,
                        deta.POLICY_SEQ,
                        deta.ID_NO,deta.ITEM,
                        ddtm1.acdntype,
                        prrs1.primtype,
                        ddtm1.DECL_YN,
                        CASE
        ...
        FROM `LP_FBDB/FCLDETA0` AS deta
             ...
             (
                 ...
                 GROUP BY ddtm.ITEM,ddtm.DECL_YN
             ) AS ddtm1
        ...
        ON (prim.RGST_NO = deta.RGST_NO)
            INNER JOIN
            (
            SELECT prrs.RGST_NO,max(substr(prrs.ACDN_REA,1,1)) AS primtype
        ...
        WHERE dfpl.DFYN_TAB LIKE 'N%'
          ...
          AND deta.CLAIM_ITEM IN ('A11E', 'A172', 'H116', 'A102', 'G105', 'A11P', 'A113', 'A11H', 'A11I', 'H117', 'G101', 'A171', 'A112', 'A11O', 'A11F', 'A604', 'A603', 'A601',
            'A11D', 'A11Q', 'A12B', 'A12D', 'A12E', 'A12F', 'A18B', 'A181', 'A812', 'A814', 'G10A', 'G118', 'G604', 'G806', 'H115')
          AND
            (
            CASE
            WHEN ddtm1.acdntype = ' ' THEN 'Y'
        ...
        INNER JOIN `LP_FBDB/FCLDETA0` AS deta2
                   ON
                       (
                               ...
                               AND deta2.CLAIM_ITEM IN ('A11E', 'A172', 'H116', 'A102', 'G105', 'A11P', 'A113', 'A11H', 'A11I', 'H117', 'G101', 'A171', 'A112', 'A11O', 'A11F', 'A604', 'A603', 'A601', 'A11D',
                                                        'A11Q', 'A12B', 'A12D', 'A12E', 'A12F', 'A18B', 'A181', 'A812', 'A814', 'G10A', 'G118', 'G604', 'G806', 'H115')
                           )
    ...
    (
        ...
        WHERE deta3.ITEM IN ('CLJ', 'CLL', 'EDUC', 'XLJ', 'XCR', 'XWU', 'XLT', 'XDA', 'XDB', 'XDC', 'XTF', 'XDH', 'XAR', 'XAR1', 'XDK', 'XDN', 'XIR', 'XOR', 'XTG', 'XTR', 'XWO',
                             'SWC', 'EDUB', 'AIH', 'AIO', 'AHY', 'IPAC', 'FIB1', 'F1B2', 'FIB3', 'FIB4', 'FIB5', 'FIC1', 'FIC2', 'FIC3', 'FIC4', 'FIC5', 'XDN1', 'XDR', 'XDR1',
                             'XLZ', 'XNR', 'XTO', 'XDS', 'XQR', 'PCC2', 'XNR', 'IXB', 'SWC', 'AI55', 'AI60', 'AI65')
          AND deta3.CLAIM_STS LIKE 'P%'
          AND deta3.CLAIM_ITEM IN ('A11E', 'A172', 'H116', 'A102', 'G105', 'A11P', 'A113', 'A11H', 'A11I', 'H117', 'G101', 'A171', 'A112', 'A11O', 'A11F', 'A604', 'A603', 'A601',
                                   'A11D', 'A11Q', 'A12B', 'A12D', 'A12E', 'A12F', 'A18B', 'A181', 'A812', 'A814', 'G10A', 'G118', 'G604', 'G806', 'H115')
